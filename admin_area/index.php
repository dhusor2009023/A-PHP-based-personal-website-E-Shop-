...
if(isset($_GET['insert_product_cat'])){ include 'insert_p_cat.php';
}
if(isset($_GET['view_product_cat'])){ include 'view_p_cat.php';
}
...
if(isset($_GET['customer_delete'])){ include 'customer_delete.php';
}
if(isset($_GET['view_orders'])){ include 'view_orders.php';
}
if(isset($_GET['order_delete'])){ include 'order_delete.php';
}
...
if(isset($_GET['user_delete'])){ include 'user_delete.php';
}
?>
