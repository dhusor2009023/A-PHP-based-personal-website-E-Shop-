...
<i class="fa a-money fa-fw"></i> Insert Employee
</h3>
...
<div class="form-group">
	...
	<div class="col-md-6">
		<input type="submit" name="submit" value="Insert Employee" class="btn btn-primary form-control">
	</div>
</div>
</form>
</div>
...
if($run_admin){
echo "<script>alert('One Employee Has Been Inserted successfully')</script>";
