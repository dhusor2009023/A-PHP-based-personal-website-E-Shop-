        ...
        <div class="col-md-9"><!--col md-9 start-->
            ...
            <div class="box"><!--box start-->
                <div class="box-header"><!--box header start-->
                    ...
                    <center>
                        <h2>Contact Us</h2>
                        <p>If you have any question, pleaase feel free to cantact us.</p>
                    </center>
...
$receiverEmail="sayekhdhusor@gmail.com";
mail($receiverEmail,$senderName,$senderSubject,$senderMessage,$senderEmail);

//customer er confirmation er jonno

$email=$_POST['email'];
$subject="Welcome to our website";
$msg="I shall get you soon, thanks for sending email";
$from="sayekhdhusor@gmail.com";
mail($email,$subject,$msg,$from);
echo "<h2 align='center'>Your mail has sent!</h2>";
