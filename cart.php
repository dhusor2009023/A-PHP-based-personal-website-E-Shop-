...
?>
                    ...
                    <p class="text-muted">Currently youy have <?php echo $count ?> item(s) in your cart</p>

                    <div class="table-responsive"><!--TAble response start-->
...
?>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="checkbox"
                                        name="remove[]" value="<?php echo $pro_id ?>">
                                    </td>
