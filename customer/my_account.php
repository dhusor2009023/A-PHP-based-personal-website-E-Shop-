...
?>
      	     ...
      	     <a href="#">
      		            Cart  Total Price: BDT 5100, Items: 5
      	    </a>
...
<div id="content"><!-- Content start-->
    ...
    <div class="container"><!-- Container start-->
        ...
        <div class="col-md-12"><!-- col md 12 start-->
            ...
            <ul class="breadcrumb"><!--bootstrap er b-->
...
<!--including playoffline page start-->
...
<!--including playoffline page end-->
...
<!--Including delete account page end-->
