...
echo "<div class='box'>
<h1>Shop</h1>
<p>This shop is organized by the students of Khulna University of Engineering and Technology, Khulna.</p>
...
<center>
    <ul class="pagination">
        ...
        if ($result) {
            ...
            echo "<li>Error fetching pagination data.</li>";
        }
        ?>
