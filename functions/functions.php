<?php
$db = mysqli_connect("localhost", "root", "", "online pet shop");

//ip address er jonno r akta function switch use korbo amra
...
function getUserIP(){
    ...
    switch (true) {
        case (!empty($_SERVER['HTTP_X_REAL_IP'])) : return $_SERVER['HTTP_X_REAL_IP'];
         ...
         case (!empty($_SERVER['HTTP_X_CLINT_IP'])) : return $_SERVER['HTTP_X_CLINT_IP'];
    ...
    while ($row_product = mysqli_fetch_array($run_products)) {
        ...
        <div class='col-md-4 col-sm-6'>
            <div class='product'>
                ...
                </div> <!-- Closing div.text -->
            </div> <!-- Closing div.product -->
...
if ($count==0) {
    echo "
    <div class='box'>
    <h1> No Product found in this Region! </h1>
    </div> ";
}
